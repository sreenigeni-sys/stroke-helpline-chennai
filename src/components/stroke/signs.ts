...
export const SIGNS: Sign[] = [
  {
    ...
    watch: "He stands up, then suddenly falls to one side.",
    watchTa: "எழுந்ததும் திடீரென ஒரு பக்கம் விழுகிறார்.",
  ...
  },
  {
    ...
    watch: "Both eyes, then one eye goes dark, then half the view, then double.",
    watchTa: "இரு கண்களும், பிறகு ஒரு கண் இருட்டு, பிறகு பாதிப் பார்வை, பிறகு இரட்டைப் பார்வை.",
